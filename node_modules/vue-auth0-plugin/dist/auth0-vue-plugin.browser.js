...
const injectAuth = () => inject(vueAuthInjectionKey);
const AuthenticationState = Plugin.state;
const AuthenticationProperties = Plugin.properties;

export { AuthenticationGuardWithLoginRedirect as AuthenticationGuard, AuthenticationGuardWithoutLoginRedirect, AuthenticationProperties, AuthenticationState, index as default, injectAuth, vueAuthInjectionKey as injectionKey };
